...
const line = '║';
const line2 = '╠➥';
const line7 = '*En breve*';
const line3 = '╠══✪〘';
const line4 = '〙✪══';
const line5 = '𝐃𝐀𝐑𝐊 𝐁𝐎𝐓';
const line6 = 'APIS DEp DARK';
const line8 = '╠═══════════════';
const line9 = '╠══';
const line10 = 'EDITS »';
const line11 = '𝐃𝐎𝐍𝐎:';
const line12 = '*wa.me/+5521970019765*';
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					group: '[❗] Este comando sólo pode ser usado em grupos! ❌',
			...
			const ownerNumber = ["5521970019765@s.whatsapp.net","12267740582@s.whatsapp.net"] // replace this with your number
